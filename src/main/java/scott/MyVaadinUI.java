...
public class MyVaadinUI extends UI {
    ...
    protected void init(VaadinRequest request) {
        ...
        class MyMonthAndYear extends MonthAndYear  {
            private Month month;
            ...
            public void notifyMonthDeleted(Month month) {
                if (this.month == month) {
                    this.month = null;
                }
    ...
    private void notifyDeleted(Month toDelete) {
        monthAndYear.notifyMonthDeleted(toDelete);
    }
